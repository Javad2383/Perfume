$(document).ready(function () {
    ...
    if ($(".card-page").length) {
        ...
        addCount.onclick = function () {
            ...
            Price.innerHTML = `$${t + 200}`;
            totalPrice.innerText = `$${(t + 200) + 3}`;
        };
    ...
    $(".owl-carousel").each(function () {
        ...
        a.owlCarousel({
            ...
            responsive: {
                ...
                576: {items: a.data("sm-items"), stagePadding: a.data("sm-padding"), nav: a.data("sm-nav")},
                768: {items: a.data("md-items"), stagePadding: a.data("md-padding"), nav: a.data("md-nav")},
                1024: {items: a.data("lg-items"), stagePadding: a.data("lg-padding"), nav: a.data("lg-nav")},
                1200: {stagePadding: a.data("xl-padding"), nav: a.data("xl-nav")}
            }
        })
    })
}
